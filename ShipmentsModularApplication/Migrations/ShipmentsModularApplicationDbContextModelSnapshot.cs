...
{
    [DbContext(typeof(ShipmentsModularApplicationDbContext))]
    partial class ShipmentsModularApplicationDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shipments.Shipments.Shipment", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("ShipmentsShipments", (string)null);
                });

            modelBuilder.Entity("Shipments.Shipments.ShipmentItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ShipmentsShipmentItems", (string)null);
                });

            modelBuilder.Entity("Stocks.Entities.ProductStock", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shipments.Shipments.Shipment", b =>
                {
                    b.OwnsOne("Shipments.Shipments.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("Shipments.Shipments.ShipmentItem", b =>
                {
                    b.HasOne("Shipments.Shipments.Shipment", "Shipment")
                        .WithMany("Items")
                        .HasForeignKey("ShipmentId")
