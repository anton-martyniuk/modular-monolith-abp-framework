...
public class ShipmentsModularApplicationDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ShipmentsModularApplicationDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
